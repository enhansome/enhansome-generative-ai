...
Contributions to this list are welcome. Before submitting your suggestions, please review the [Contribution Guidelines](CONTRIBUTING.md) to ensure your entries meet the criteria. Add links through [pull requests](https://github.com/steven2358/awesome-generative-ai/pulls) ⭐ 12,646 | 🐛 677 | 📅 2026-09-16 or create an [issue](https://github.com/steven2358/awesome-generative-ai/issues) ⭐ 12,646 | 🐛 677 | 📅 2026-09-16 to start a discussion. More projects can be found in the [Discoveries List](DISCOVERIES.md), where we showcase a wide range of up-and-coming Generative AI projects.
...
* [Qwen](https://qwenlm.github.io/) - A series of LLMs independently developed by Alibaba Cloud. [#opensource](https://github.com/QwenLM/Qwen) ⭐ 21,763 | 🐛 42 | 🌐 Python | 📅 2026-03-05
* [Kimi K2](https://github.com/moonshotai/Kimi-K2) ⭐ 11,122 | 🐛 72 | 📅 2026-01-21 - A series of open-source MoE language models by Moonshot AI for agentic tasks. #opensource
* [GLM](https://github.com/zai-org/GLM-5) ⭐ 7,194 | 🐛 32 | 📅 2026-09-01 - A series of open-source MoE language models by Z.ai for agentic tasks. #opensource
...
* [LibreChat](https://librechat.ai/) - LibreChat is a free and open-source chat interface for assistant AIs. [#opensource](https://github.com/danny-avila/LibreChat) ⭐ 44,353 | 🐛 749 | 🌐 TypeScript | 📅 2026-09-17.
* [Chatbot UI](https://www.chatbotui.com/) - An open source ChatGPT UI. [#opensource](https://github.com/mckaywrigley/chatbot-ui) ⭐ 33,348 | 🐛 242 | 🌐 TypeScript | 📅 2024-08-03.
...
* [privateGPT](https://github.com/zylon-ai/private-gpt) ⭐ 57,517 | 🐛 8 | 🌐 Python | 📅 2026-09-16 - Ask questions to your documents without an internet connection, using the power of LLMs.
* [quivr](https://github.com/QuivrHQ/quivr) ⭐ 39,530 | 🐛 34 | 🌐 Python | 📅 2026-08-31 - Dump all your files and chat with it using your generative AI second brain using LLMs & embeddings.

### Writing assistants

* [Humanize-Text](https://github.com/lynote-ai/humanize-text) ⭐ 3,033 | 🐛 28 | 🌐 Python | 📅 2026-09-16 - AI text humanizer with a multilingual rewriting pipeline and step-by-step examples. #opensource
...
* [Open Notebook](https://www.open-notebook.ai) - An open source implementation of NotebookLM with more flexibility and features. [#opensource](https://github.com/lfnovo/open-notebook) ⭐ 39,052 | 🐛 113 | 🌐 TypeScript | 📅 2026-09-13
* [Screenpipe](https://github.com/screenpipe/screenpipe) ⭐ 21,609 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-17 - An open-source tool for recording screen and audio activity with AI-powered search, automations, and support for local LLMs. #opensource
...
* [STORM](https://storm.genie.stanford.edu/) - An LLM-powered knowledge curation system that researches a topic and generates a full-length report with citations. [#opensource](https://github.com/stanford-oval/storm/) ⭐ 31,421 | 🐛 108 | 🌐 Python | 📅 2025-09-30
* [Local Deep Research](https://github.com/LearningCircuit/local-deep-research) ⭐ 9,098 | 🐛 909 | 🌐 Python | 📅 2026-09-17 - A deep research tool for searching academic sources, the web, and private documents with local or cloud LLMs. [#opensource](https://github.com/LearningCircuit/local-deep-research) ⭐ 9,098 | 🐛 909 | 🌐 Python | 📅 2026-09-17
* [Paper2Agent](https://paper2agent.ai/) - Converts research papers and associated codebases into tested MCP servers and interactive AI agents. [#opensource](https://github.com/jmiao24/Paper2Agent) ⭐ 2,778 | 🐛 0 | 🌐 Python | 📅 2026-09-16
* [ASReview](https://asreview.nl/) - Open-source AI-powered tool for systematic reviews, helping researchers screen large volumes of academic literature efficiently. [#opensource](https://github.com/asreview/asreview) ⭐ 1,008 | 🐛 118 | 🌐 Python | 📅 2026-09-14
...
* [Open Interpreter](https://github.com/openinterpreter/open-interpreter) ⭐ 68,362 | 🐛 1 | 🌐 Rust | 📅 2026-09-15 - OpenAI's Code Interpreter in your terminal, running locally.
* [aider](https://aider.chat/) - AI pair programming in your terminal, supporting multiple LLM providers. [#opensource](https://github.com/paul-gauthier/aider) ⭐ 49,017 | 🐛 1,875 | 🌐 Python | 📅 2026-05-22
* [Continue](https://www.continue.dev/) - Open-source AI code assistant. Connect any model and any context to create custom autocomplete and chat experiences inside the IDE. [#opensource](https://github.com/continuedev/continue) ⭐ 35,940 | 🐛 965 | 🌐 TypeScript | 📅 2026-09-16
* [Kilo](https://kilo.ai/) - Open-source AI coding assistant for VS Code, JetBrains, and the CLI. [#opensource](https://github.com/Kilo-Org/kilocode) ⭐ 27,333 | 🐛 539 | 🌐 TypeScript | 📅 2026-09-17
...
* [Plandex](https://github.com/plandex-ai/plandex) ⭐ 15,638 | 🐛 62 | 🌐 Go | 📅 2025-10-03 - Open source, terminal-based AI programming engine for complex tasks. [#opensource](https://github.com/plandex-ai/plandex) ⭐ 15,638 | 🐛 62 | 🌐 Go | 📅 2025-10-03
* [PR-Agent](https://github.com/The-PR-Agent/pr-agent) ⭐ 13,045 | 🐛 70 | 🌐 Python | 📅 2026-09-17 - AI-powered tool for automated PR analysis, feedback, suggestions and more.
* [Jupyter AI](https://github.com/jupyterlab/jupyter-ai) ⭐ 4,406 | 🐛 306 | 🌐 Python | 📅 2026-09-17 - An open-source, configurable AI assistant in Jupyter Notebook and JupyterLab that supports 100+ LLMs, including locally-hosted models from Ollama and GPT4All. #opensource
...
* [llama.cpp](https://github.com/ggml-org/llama.cpp) ⭐ 128,535 | 🐛 2,472 | 🌐 C++ | 📅 2026-09-17 - Inference of Meta's LLaMA model (and others) in pure C/C++. #opensource
* [gpt4all](https://github.com/nomic-ai/gpt4all) ⭐ 77,399 | 🐛 771 | 🌐 C++ | 📅 2025-05-27 - A chatbot trained on a massive collection of clean assistant data including code, stories and dialogue.
* [Unsloth](https://unsloth.ai) - A Python library for fine-tuning LLMs [#opensource](https://github.com/unslothai/unsloth) ⭐ 76,283 | 🐛 1,258 | 🌐 Python | 📅 2026-09-17.
* [LLM App](https://github.com/pathwaycom/llm-app) ⭐ 58,922 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-07-05 - Open-source Python library to build real-time LLM-enabled data pipeline.
* [bitnet.cpp](https://github.com/microsoft/BitNet) ⭐ 40,267 | 🐛 332 | 🌐 C++ | 📅 2026-07-27 - Official inference framework for 1-bit LLMs, by Microsoft. [#opensource](https://github.com/microsoft/BitNet) ⭐ 40,267 | 🐛 332 | 🌐 C++ | 📅 2026-07-27
* [Langfuse](https://langfuse.com/) - An open-source LLM engineering platform for tracing, evaluation, prompt management, and metrics. [#opensource](https://github.com/langfuse/langfuse) ⭐ 34,721 | 🐛 920 | 🌐 TypeScript | 📅 2026-09-17
* [Repomix](https://repomix.com/) - Pack your codebase into AI-friendly formats. [#opensource](https://github.com/yamadashy/repomix) ⭐ 28,386 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-13
* [MLflow](https://mlflow.org/) - An open-source platform for tracking ML experiments, evaluating models and prompts, deploying models, and adding LLM observability. [#opensource](https://github.com/mlflow/mlflow) ⭐ 27,995 | 🐛 2,100 | 🌐 Python | 📅 2026-09-17
...
* [Opik](https://github.com/comet-ml/opik) ⭐ 22,093 | 🐛 265 | 🌐 Python | 📅 2026-09-17 - An open-source platform for tracing, evaluating, and monitoring LLM applications. [#opensource](https://github.com/comet-ml/opik) ⭐ 22,093 | 🐛 265 | 🌐 Python | 📅 2026-09-17
* [Wren AI](https://www.getwren.ai/oss) - An open-source text-to-SQL and generative BI agent with a semantic layer. [#opensource](https://github.com/Canner/WrenAI) ⭐ 17,673 | 🐛 302 | 🌐 Python | 📅 2026-09-17
* [Gitingest](https://gitingest.com/) - Turn any Git repository into a simple text digest of its codebase so it can be fed into any LLM. [#opensource](https://github.com/cyclotruc/gitingest) ⭐ 15,498 | 🐛 20 | 🌐 Python | 📅 2026-09-09
* [Ludwig](https://github.com/ludwig-ai/ludwig) ⭐ 11,757 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - A low-code framework for building custom AI models like LLMs and other deep neural networks. [#opensource](https://github.com/ludwig-ai/ludwig) ⭐ 11,757 | 🐛 1 | 🌐 Python | 📅 2026-09-14
* [Model Context Protocol](https://modelcontextprotocol.io/) - An open standard for connecting AI models to external tools and data sources. [MCP Registry](https://registry.modelcontextprotocol.io/) [#opensource](https://github.com/modelcontextprotocol/modelcontextprotocol) ⭐ 9,236 | 🐛 149 | 🌐 TypeScript | 📅 2026-09-16
* [Bifrost](https://github.com/maximhq/bifrost) ⭐ 8,134 | 🐛 1,047 | 🌐 Go | 📅 2026-09-17 - An open-source LLM gateway with routing, load balancing, guardrails, and observability for 1000+ models. #opensource
* [Steel Browser](https://github.com/steel-dev/steel-browser) ⭐ 7,653 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-16 - An open-source browser sandbox and automation infrastructure for AI agents, with session management, screenshots, PDFs, proxies, and anti-bot tooling. #opensource
* [Manifest](https://manifest.build) - An open-source LLM router that routes agent requests to the most cost-effective model, with usage limits and model benchmarking. [#opensource](https://github.com/mnfst/manifest) ⭐ 7,527 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-16
* [Helicone AI](https://helicone.ai/) - Open-source LLM observability platform for logging, monitoring, and debugging AI applications. [#opensource](https://github.com/Helicone/helicone) ⭐ 6,161 | 🐛 156 | 🌐 TypeScript | 📅 2026-09-16
* [agenta](https://github.com/agenta-ai/agenta) ⭐ 4,763 | 🐛 351 | 🌐 TypeScript | 📅 2026-09-17 - An open-source end-to-end LLMOps platform for prompt engineering, evaluation, and deployment. #opensource
* [OpenLIT](https://github.com/openlit/openlit) ⭐ 2,770 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-17 - Open-source GenAI and LLM observability platform native to OpenTelemetry with traces and metrics. #opensource
* [Agentset](https://agentset.ai/) - An open-source platform for building and evaluating RAG and agentic applications. [#opensource](https://github.com/agentset-ai/agentset) ⭐ 2,088 | 🐛 16 | 🌐 TypeScript | 📅 2026-07-16
* [SymbolicAI](https://github.com/ExtensityAI/symbolicai) ⭐ 1,769 | 🐛 1 | 🌐 Python | 📅 2026-09-16 - A neuro-symbolic framework for building applications with LLMs at the core.
...
* [Ollama](https://github.com/ollama/ollama) ⭐ 181,238 | 🐛 4,031 | 🌐 Go | 📅 2026-09-17 - Get up and running with large language models locally.
* [Open WebUI](https://github.com/open-webui/open-webui) ⭐ 152,352 | 🐛 306 | 🌐 Python | 📅 2026-09-17 - An extensible, feature-rich, and user-friendly self-hosted AI platform designed to operate entirely offline. #opensource
* [Jan](https://jan.ai/) - Run LLMs like Mistral or Llama2 locally and offline on your computer, or connect to remote AI APIs. [#opensource](https://github.com/janhq/jan) ⭐ 44,507 | 🐛 536 | 🌐 TypeScript | 📅 2026-09-17
* [LLM](https://llm.datasette.io/) - A CLI utility and Python library for interacting with Large Language Models, remote and local. [#opensource](https://github.com/simonw/llm) ⭐ 12,520 | 🐛 696 | 🌐 Python | 📅 2026-09-08
* [Rapid-MLX](https://github.com/raullenchai/Rapid-MLX) ⭐ 3,767 | 🐛 54 | 🌐 Python | 📅 2026-09-17 - OpenAI-compatible local LLM inference server optimized for Apple Silicon, with tool calling, reasoning, vision, and structured output support. #opensource
* [Harbor](https://github.com/av/harbor) ⭐ 3,218 | 🐛 68 | 🌐 Python | 📅 2026-09-13 - A containerized toolkit for running local LLM backends, UIs, and supporting services with one command. #opensource
* [off-grid-mobile](https://github.com/alichherawalla/off-grid-mobile-ai) ⭐ 3,117 | 🐛 150 | 🌐 TypeScript | 📅 2026-09-17 - React Native app for running LLMs, vision models, and Stable Diffusion on-device on iOS and Android without internet access. #opensource
...
* [OpenClaw](https://openclaw.ai) - A personal AI assistant you run on your own devices. [#opensource](https://github.com/openclaw/openclaw) ⭐ 389,954 | 🐛 7,607 | 🌐 TypeScript | 📅 2026-09-17
* [Hermes Agent](https://hermes-agent.nousresearch.com) - A self-improving personal agent with memory, messaging integrations, and sandboxed tool execution. [#opensource](https://github.com/NousResearch/hermes-agent) ⭐ 246,378 | 🐛 43,760 | 🌐 Python | 📅 2026-09-17
* [OpenCode](https://opencode.ai) - The open-source AI coding agent. [#opensource](https://github.com/anomalyco/opencode) ⭐ 208,039 | 🐛 5,832 | 🌐 TypeScript | 📅 2026-09-17
* [Auto-GPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 187,401 | 🐛 575 | 🌐 Python | 📅 2026-09-17 - An experimental open-source attempt to make GPT-4 fully autonomous.
* [Gemini CLI](https://geminicli.com) - An open-source AI agent that brings the power of Gemini directly into your terminal. [#opensource](https://github.com/google-gemini/gemini-cli) ⭐ 107,028 | 🐛 849 | 🌐 TypeScript | 📅 2026-09-17
* [OpenHands](https://github.com/OpenHands/OpenHands) ⭐ 88,258 | 🐛 807 | 🌐 TypeScript | 📅 2026-09-17 - An autonomous agent designed to navigate the complexities of software engineering. #opensource
* [MetaGPT](https://github.com/FoundationAgents/MetaGPT) ⭐ 70,453 | 🐛 132 | 🌐 Python | 📅 2026-01-21 - The Multi-Agent Framework: Given one line requirement, return PRD, design, tasks, repo.
* [AutoGen](https://github.com/microsoft/autogen) ⭐ 61,013 | 🐛 1,074 | 🌐 Python | 📅 2026-04-15 - AutoGen is a framework that enables the development of LLM applications using multiple agents that can converse with each other to solve tasks.
...
* [Mastra](https://mastra.ai) - A TypeScript framework for building AI agents, workflows, and applications. [#opensource](https://github.com/mastra-ai/mastra) ⭐ 28,129 | 🐛 533 | 🌐 TypeScript | 📅 2026-09-17
* [Agent Skills](https://agentskills.io) - Open format and reference SDK for packaging reusable capabilities and expertise for AI agents. [#opensource](https://github.com/agentskills/agentskills) ⭐ 25,434 | 🐛 78 | 🌐 Python | 📅 2026-08-09
* [babyagi](https://github.com/yoheinakajima/babyagi) ⭐ 22,351 | 🐛 29 | 🌐 Python | 📅 2026-01-31 - An AI-powered task management system.
* [Davika](https://github.com/stitionai/devika) ⭐ 19,568 | 🐛 196 | 🌐 Python | 📅 2025-09-25 - An agentic AI software engineer. #opensource
* [Hive](https://github.com/aden-hive/hive) ⭐ 11,050 | 🐛 1,354 | 🌐 Python | 📅 2026-09-14 - An open-source multi-agent framework with auto-generated graphs, evolution loops, and MCP integration. #opensource
* [GPT Prompt Engineer](https://github.com/mshumer/gpt-prompt-engineer) ⭐ 9,683 | 🐛 34 | 🌐 Jupyter Notebook | 📅 2025-10-16 - Automated prompt engineering. It generates, tests, and ranks prompts to find the best ones.
* [PraisonAI](https://github.com/MervinPraison/PraisonAI) ⭐ 9,065 | 🐛 73 | 🌐 Python | 📅 2026-09-17 - A framework for building multi-agent AI systems with workflows, tool integrations, and memory. #opensource
* [OpenAgents](https://github.com/openagents-org/openagents) ⭐ 4,107 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-17 - Open-source platform for building AI agent networks with multi-protocol support (WebSocket, gRPC, HTTP, MCP, A2A). #opensource
...
* [Flux](https://github.com/black-forest-labs/flux) ⭐ 25,964 | 🐛 217 | 🌐 Python | 📅 2025-07-31 - Text-to-image models by Black Forest Labs with high-quality photorealistic output. #opensource
...
* [ComfyUI](https://github.com/comfyanonymous/ComfyUI) ⭐ 133,613 | 🐛 4,884 | 🌐 Python | 📅 2026-09-17 - A node-based interface for building and running Stable Diffusion workflows. [#opensource](https://github.com/comfyanonymous/ComfyUI) ⭐ 133,613 | 🐛 4,884 | 🌐 Python | 📅 2026-09-17
...
* [HyperFrames](https://hyperframes.heygen.com/) - A framework for AI agents to render videos by writing HTML, CSS, and JavaScript. [#opensource](https://github.com/heygen-com/hyperframes) ⭐ 50,924 | 🐛 170 | 🌐 TypeScript | 📅 2026-09-17
...
* [Whisper](https://openai.com/index/whisper/) - Robust speech recognition via large-scale weak supervision. [#opensource](https://github.com/openai/whisper) ⭐ 109,268 | 🐛 149 | 🌐 Python | 📅 2026-08-31
* [whisper.cpp](https://github.com/ggml-org/whisper.cpp) ⭐ 53,722 | 🐛 351 | 🌐 C++ | 📅 2026-09-15 - Port of OpenAI's Whisper model in C/C++. #opensource
* [NeMo](https://github.com/NVIDIA-NeMo/Speech) ⭐ 18,466 | 🐛 314 | 🌐 Python | 📅 2026-09-17 - An open-source framework by NVIDIA for building speech AI systems, including automatic speech recognition and text-to-speech. #opensource
* [Vibe Transcribe](https://thewh1teagle.github.io/vibe/) - All-in-one solution for effortless audio and video transcription. [#opensource](https://github.com/thewh1teagle/vibe) ⭐ 7,519 | 🐛 164 | 🌐 TypeScript | 📅 2026-09-05
...
* [Prompt Engineering Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) ⭐ 78,401 | 🐛 281 | 🌐 MDX | 📅 2026-03-11 - Guide and resources for prompt engineering.
* [OpenAI Cookbook](https://github.com/openai/openai-cookbook) ⭐ 76,032 | 🐛 295 | 🌐 Jupyter Notebook | 📅 2026-09-17 - Examples and guides for using the OpenAI API.
* [Anthropic courses](https://github.com/anthropics/courses) ⚠️ Archived - Anthropic's educational courses.
* [Transformer Explainer](https://poloclub.github.io/transformer-explainer/) - Interactive visualization of how transformer-based LLMs work, running a live GPT-2 model in the browser. [#opensource](https://github.com/poloclub/transformer-explainer) ⭐ 8,590 | 🐛 21 | 🌐 JavaScript | 📅 2026-06-06
...
* [The Generative AI Landscape](https://github.com/ai-collection/ai-collection) ⭐ 9,159 | 🐛 26 | 📅 2026-09-17 - A Collection of Awesome Generative AI Applications.
* [Generative Deep Art](https://github.com/filipecalegario/awesome-generative-ai) ⭐ 3,539 | 🐛 311 | 📅 2025-12-18 - A curated list of generative deep learning tools, works, models, etc. for artistic uses, by [@filipecalegario](https://github.com/filipecalegario/).
...
* [Awesome RAG Production](https://github.com/Yigtwxx/Awesome-RAG-Production) ⭐ 261 | 🐛 7 | 🌐 Python | 📅 2026-09-10 - A curated list of tools and resources for building production RAG systems.
...
* [Awesome ChatGPT Prompts](https://github.com/f/prompts.chat) ⭐ 170,527 | 🐛 79 | 🌐 HTML | 📅 2026-09-09 - A collection of prompt examples to be used with the ChatGPT model.
...
* [Awesome ChatGPT](https://github.com/sindresorhus/awesome-chatgpt) ⭐ 6,410 | 🐛 6 | 📅 2026-02-15 - Another awesome list for ChatGPT.
